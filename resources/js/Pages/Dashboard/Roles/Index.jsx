...
export default function Index() {
    ...
    return (
        <>
            ...
            >
                <form onSubmit={data.isUpdate === true ? updateRole : saveRole}>
                    ...
                    <Button
                        ...
                        className={
                            "border bg-white text-gray-700 hover:bg-gray-100 dark:bg-gray-950 dark:border-gray-800 dark:text-gray-200"
                        }
                        added={true}
                        label={"Simpan"}
                    />
            ...
            <Card title={"Data Akses Group"}>
                <Table>
                    <Thead>
                        <tr>
                            <Th className="w-10">No</Th>
                            <Th>Nama Akses Group</Th>
                            <Th>Hak Akses</Th>
