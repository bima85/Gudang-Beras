...
export default function Edit({ transaction }) {
    ...
    const form = useForm({
        transaction_date:
            transaction.transaction_date?.slice(0, 16) ||
            new Date().toISOString().slice(0, 16),
        transaction_number: transaction.transaction_number || "",
        transaction_type: transaction.transaction_type || "purchase",
        product_id: transaction.product_id || (products[0]?.id ?? null),
        quantity: transaction.quantity || 0,
        unit: transaction.unit || "pcs",
        price: transaction.price || "",
        toko_id:
            transaction.toko_id || (tokos && tokos[0]?.id ? tokos[0].id : null),
    ...
    function submit(e) {
        e.preventDefault();
        form.put(route("transaction-histories.update", transaction.id), {
            onSuccess: () => {
    ...
    return (
        <>
            <Head title="Edit Histori Transaksi" />
            <div className="p-4 max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold">
                        Edit Histori Transaksi
                    </h1>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Form Edit Histori Transaksi</CardTitle>
                    </CardHeader>
                    <CardContent>
