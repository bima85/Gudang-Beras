...
export default function Index({
    ...
    stocks.forEach((stock) => {
        const warehouseName = stock.warehouse?.name || "Tanpa Gudang";
        if (!groupedStocks[warehouseName]) {
            groupedStocks[warehouseName] = [];
        }
        groupedStocks[warehouseName].push(stock);
    });
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
                ...
                {/* Tabel Stok Gudang Grouped by Warehouse */}
                {Object.keys(groupedStocks).length === 0 ? (
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center text-gray-500 dark:text-gray-400">
                        Data stok gudang belum ada.
                    </div>
                ) : (
                    Object.entries(groupedStocks).map(
                        ([warehouseName, stocks], idx) => (
                            <div
                                key={warehouseName}
                                className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-x-auto mb-8"
                            >
                                <h3 className="text-lg font-bold px-4 py-3 border-b bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">
