...
const Card = ({ icon, title, className, children }) => {
    return (
        <>
            <div
                className={`p-4 rounded-t-lg border ${className} bg-white dark:bg-gray-950 dark:border-gray-900 `}
            >
...
const Thead = ({ className, children }) => {
    return (
        <thead
            className={`${className} border-b bg-gray-50 dark:border-gray-900 dark:bg-gray-950`}
        >
            {children}
        </thead>
    );
...
const Tbody = ({ className, children }) => {
    return (
        <tbody
            className={`${className} divide-y bg-white dark:divide-gray-900 dark:bg-gray-950`}
        >
            {children}
        </tbody>
    );
...
const Empty = ({ colSpan, message, children, className }) => {
    return (
        <tr>
            <td colSpan={colSpan}>
...
export { Table, Card, Thead, Tbody, Tr, Th, Td, Tfoot, Empty };
