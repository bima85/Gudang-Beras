...
return [
    ...
    */
    ...
    'debug' => (bool) env('APP_DEBUG', false),
    'url' => env('APP_URL', 'http://localhost'),
    'timezone' => env('APP_TIMEZONE', 'Asia/Jakarta'), // Sesuaikan dengan WIB
    'locale' => env('APP_LOCALE', 'en'),
    'fallback_locale' => env('APP_FALLBACK_LOCALE', 'en'),
    'faker_locale' => env('APP_FAKER_LOCALE', 'en_US'),
    'cipher' => 'AES-256-CBC',
    ...
    */
    'providers' => [
        ...
        // Barryvdh\DomPDF\ServiceProvider::class, // Tambahkan jika menggunakan PDF
    ...
    */
    'aliases' => [
        ...
        // 'Pdf' => Barryvdh\DomPDF\Facade\Pdf::class, // Tambahkan jika menggunakan PDF
    ],
];
