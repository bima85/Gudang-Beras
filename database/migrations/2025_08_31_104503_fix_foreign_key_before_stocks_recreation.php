...
class FixForeignKeyBeforeStocksRecreation extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        // Intentionally left empty: this migration only removes a problematic FK prior to a table recreation
    }
}
